  ...
  <section className="py-24 md:py-32 px-6 bg-secondary overflow-hidden">
    <div className="max-w-2xl mx-auto text-center">
      <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}
        className="font-body text-xs tracking-[0.3em] uppercase text-gold mb-8">Qué es</motion.p>
      ...
      <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={2}
        ...
        Sacred Stillness es un espacio diseñado para que tu sistema nervioso salga del estado de alerta constante…
      </motion.p>
      <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={3}
        className="font-display text-xl md:text-2xl font-light italic text-foreground/90 mb-10">y entre en regulación profunda.</motion.p>
      <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={4}
        ...
        A través de presencia, trabajo somático y energía, tu cuerpo empieza a hacer algo que quizá olvidó:
      </motion.p>
      <motion.p initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
        transition={{ duration: 0.8, delay: 0.5, ease: [0.22, 1, 0.36, 1] }}
        className="font-display text-2xl md:text-3xl font-light italic text-foreground mt-8">sentirse seguro.</motion.p>
    </div>
  </section>
);
