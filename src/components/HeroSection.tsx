  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-10 text-center px-6 max-w-3xl mx-auto" style={{ opacity: textOpacity, y: textY }}>
        ...
        <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 0.8, delay: 0.6, ease: "easeOut" }} className="gold-line mb-6" />
        ...
        <motion.blockquote initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 1.4 }}
